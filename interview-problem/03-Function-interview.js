...
function getScore() {
  var num1 = 3,
    num2 = 4;
  function add() {
    return name + " scored " + (num1 + num2); // Satyam scored 7
  }
  return add();
}
getScore();
...
let user = {
    name: "Roadside Coder",
    rc1: () => {
      console.log("Subscribe to " + this.name);  // undefined, because arrow function does not have its own 'this'
    },
    rc2() {
      console.log("Subscribe to " + this.name); // "Roadside Coder", because normal function has its own 'this' o/p is subscribe to Roadside Coder
    },
};
